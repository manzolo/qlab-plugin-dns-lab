...
echo ""; echo "${BOLD}=========================================${RESET}"; echo "${BOLD}  dns-lab — Automated Test Suite${RESET}"; echo "${BOLD}=========================================${RESET}"; echo ""
...
run_test "01"; run_test "02"; run_test "03"; run_test "04"; run_test "05"; run_test "06"; run_test "07"
